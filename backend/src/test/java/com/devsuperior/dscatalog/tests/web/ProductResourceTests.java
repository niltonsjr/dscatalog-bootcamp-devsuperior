...
public class ProductResourceTests {
	...
	private ProductDTO invalidPriceProductDTO;
	...
	void setUp() throws Exception {
		...
		invalidPriceProductDTO = ProductFactory.createProductDTO(existingId);
		invalidPriceProductDTO.setPrice(-1.0);
	...
	@Test
	public void insertShouldReturnUnprocessableEntityWhenDataAreNotValid() throws Exception {
		String accessToken = obtainAccessToken(operatorUsername, operatorPassword);		
		String jsonBody = objectMapper.writeValueAsString(invalidPriceProductDTO);
	...
	@Test
	public void insertShouldReturnCreatedWhenDataAreValid() throws Exception {
		String accessToken = obtainAccessToken(operatorUsername, operatorPassword);		
	...
	@Test
	public void updateShouldReturnProductDTOdWhenIdExists() throws Exception {
		String accessToken = obtainAccessToken(operatorUsername, operatorPassword);
		String jsonBody = objectMapper.writeValueAsString(newProductDTO);
		String expectedName = newProductDTO.getName();
		Double expectedPrice = newProductDTO.getPrice();
